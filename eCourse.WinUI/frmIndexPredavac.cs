using eCourse.WinUI.Izvjestaji;
...
{
    public partial class frmIndexPredavac : Form
    {
        private int childFormNumber = 0;

        public frmIndexPredavac()
        {
            InitializeComponent();
        }
        ...
        private void izvještavanjeOUplatamaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var frm = new frmUplateRpt();
            frm.MdiParent = this;
            frm.WindowState = FormWindowState.Normal;
            frm.Show();
        }

        private void izvještavanjeOPopularnostiKursevaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var frm = new frmKursRpt();
            frm.MdiParent = this;
            frm.WindowState = FormWindowState.Normal;
            frm.Show();
        }
